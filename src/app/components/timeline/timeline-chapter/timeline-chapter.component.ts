...
@Component({
  selector: 'app-timeline-chapter',
  templateUrl: './timeline-chapter.component.html',
  styleUrls: ['./timeline-chapter.component.scss']
})
export class TimelineChapterComponent implements OnInit {
  ...
  ngOnInit() {
    this.t_period = this.all_chapters[this.id_period];
